#!/usr/bin/env python3
"""
Test email sending after fixing the CLI input blocking issue.
...
def create_test_excel():
    ...
    data = {
        ...
        'description': ['Testing email 1', 'Testing email 2']
    }
...
if __name__ == "__main__":
    ...
    if not test_server_availability():
        print("❌ Server not available at http://localhost:8001")
